...
async def send_security_code(to: Annotated[EmailStr, Query()], db: Annotated[AsyncSession, Depends(get_db)]):
    ...
    await smtp.send_email(to=to, subject="Your security code for password reset", content=content)
