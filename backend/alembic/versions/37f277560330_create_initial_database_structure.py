...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "balance", sa.Numeric(precision=15, scale=2), server_default=sa.text("0"), nullable=False
        ),
    ...
    op.create_table(
        "transactions",
        sa.Column(
            "amount", sa.Numeric(precision=15, scale=2), server_default=sa.text("0"), nullable=False
        ),
